        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDataBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDataUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDataUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedDataUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalAttributes = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    ProductFeatures = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    CreatedDataBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDataUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
